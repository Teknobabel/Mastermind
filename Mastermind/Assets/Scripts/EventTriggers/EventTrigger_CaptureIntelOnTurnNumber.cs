...
[CreateAssetMenu(menuName = "EventTrigger/Capture Intel On Turn Number")]
public class EventTrigger_CaptureIntelOnTurnNumber : EventTriggerBase {
	...
	{
		if (GameManager.instance.game.turnNumber >= m_turnNumber && GameManager.instance.game.intelInPlay.Count > 0) {
