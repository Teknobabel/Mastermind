...
[CreateAssetMenu(menuName = "EventTrigger/Attack Base On Wanted Level")]
public class EventTrigger_AttackBaseOnWantedLevel : EventTriggerBase {
	...
	{
		if (GameManager.instance.game.player.currentWantedLevel >= m_wantedLevel) {
