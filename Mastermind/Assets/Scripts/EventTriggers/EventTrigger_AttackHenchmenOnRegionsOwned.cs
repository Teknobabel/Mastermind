...
[CreateAssetMenu(menuName = "EventTrigger/Attack Henchmen On Regions Owned")]
public class EventTrigger_AttackHenchmenOnRegionsOwned : EventTriggerBase {
	...
	{
		if (GameManager.instance.game.player.currentHenchmen.Count > 0 && GameManager.instance.game.player.GetNumOwnedRegions() >= m_regionsOwned) {
