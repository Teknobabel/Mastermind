...
[CreateAssetMenu(menuName = "EventTrigger/Capture Intel On Num Intel Available")]
public class EventTrigger_CaptureIntelOnNumIntelAvailable : EventTriggerBase {
	...
	{
		if (GameManager.instance.game.intelInPlay.Count >= m_numIntelInPlay) {
