...
[CreateAssetMenu(menuName = "EventTrigger/Free Regions On Intel Captured")]
public class EventTrigger_FreeRegionsOnIntelCaptured : EventTriggerBase {
	...
	{
		if (GameManager.instance.game.player.currentIntel >= m_numCapturedIntel && GameManager.instance.game.player.GetNumOwnedRegions() > 0) {
